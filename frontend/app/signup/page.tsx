...
const features = [
  "5 free AI-generated layouts per month",
  "Access to 1000+ premium posters",
  "Save unlimited room projects",
  "Export high-resolution mockups",
]

export default function SignupPage() {
  const router = useRouter()
  const { signup, isLoading, error, clearError, user, isHydrated, hydrate } = useAuthStore()
  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-4 animated-gradient relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-80 h-80 rounded-full bg-primary/5 blur-[100px]" />
        
        {/* Floating posters */}
        <motion.div
          className="absolute top-32 right-[10%] w-20 h-28 rounded-lg bg-secondary/30 border border-border/50"
          animate={{ y: [0, -15, 0], rotate: [5, 2, 5] }}
          transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute bottom-20 left-[15%] w-24 h-32 rounded-lg bg-secondary/30 border border-border/50"
      ...
      >
        ...
        <div className="glass rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Start designing your perfect walls</p>
          </div>
